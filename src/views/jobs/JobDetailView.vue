  ...
  <div class="min-h-screen bg-slate-50 dark:bg-slate-950">
    ...
    <div class="max-w-6xl mx-auto px-4 -mt-16 md:-mt-20 relative z-10 pb-20">
      ...
      <div v-else-if="job" class="space-y-8">
        <!-- Header Card -->
        <div
          class="bg-white dark:bg-slate-900 rounded-[2rem] shadow-xl shadow-indigo-500/5 border border-slate-100 dark:border-slate-800 overflow-hidden"
        >
          <div class="p-6 md:p-10">
            <div class="flex flex-col md:flex-row gap-6 md:items-start">
              ...
              <div class="flex-shrink-0 -mt-2 md:mt-0">
                <div
                  class="w-20 h-20 md:w-24 md:h-24 bg-white dark:bg-slate-800 rounded-[1.5rem] shadow-xl border-4 border-white dark:border-slate-900 flex items-center justify-center overflow-hidden"
                >
                  <img
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="flex flex-wrap items-start justify-between gap-4 mb-3">
                  <div class="min-w-0">
                    <h1
                      class="text-2xl md:text-3xl font-black text-slate-900 dark:text-white leading-tight mb-2"
                    >
                      {{ job.title }}
                    </h1>
                  ...
                  <div class="flex items-center gap-3 flex-shrink-0">
                    <button
                      ...
                      :class="
                        isSaved
                          ? 'bg-rose-50 text-rose-500 dark:bg-rose-900/20 border-rose-200'
                ...
                <div class="flex flex-wrap gap-2 mb-5">
                  ...
                  <span
                    :class="workplaceClass(job.workplace_type)"
                    class="text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-xl border"
                  >
                    <i class="pi pi-globe mr-1"></i>{{ job.workplace_type?.replace('_', ' ') }}
                  </span>
                  <span
                    :class="experienceClass(job.experience_level)"
                    class="text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-xl border"
                  >
                    {{ job.experience_level }}
                  </span>
                  <span
                    v-if="job.vacancies > 1"
                    class="text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-xl border bg-slate-50 text-slate-600 dark:bg-slate-800 dark:text-slate-400"
                  >
                ...
                <!-- Meta Row -->
                <div
                  class="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-slate-500 dark:text-slate-400 font-medium"
                >
            ...
            <!-- Apply CTA Bar -->
            <div
              class="mt-8 pt-6 border-t border-slate-50 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4"
            >
              <div>
              ...
              <div class="flex items-center gap-3 w-full sm:w-auto">
                ...
                <template v-if="applyState === 'applied'">
                  <div
                    class="flex items-center gap-3 px-6 py-3.5 bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-900/20 rounded-2xl"
                  >
                    ...
                    <div>
                      ...
                      <p class="text-[10px] text-emerald-600 dark:text-emerald-500 font-medium">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-8">
          ...
          <div class="space-y-8">
            <!-- Description -->
            <section
              class="bg-white dark:bg-slate-900 rounded-[2rem] p-8 md:p-10 shadow-sm border border-slate-100 dark:border-slate-800"
            >
              <h2
                class="text-xl font-black text-slate-900 dark:text-white mb-6 flex items-center gap-3"
              >
                <span
                  class="w-8 h-8 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl flex items-center justify-center text-indigo-600"
                >
              ...
              <div
                class="prose prose-slate max-w-none text-slate-600 dark:text-slate-300 leading-relaxed"
            ...
            >
              ...
              >
                <span
                  class="w-8 h-8 bg-rose-50 dark:bg-rose-900/20 rounded-xl flex items-center justify-center text-rose-600"
                >
            ...
            >
              ...
              >
                <span
                  class="w-8 h-8 bg-amber-50 dark:bg-amber-900/20 rounded-xl flex items-center justify-center text-amber-600"
                >
            ...
            >
              ...
              >
                <span
                  class="w-8 h-8 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl flex items-center justify-center text-emerald-600"
                >
            ...
            >
              ...
              >
                <span
                  class="w-8 h-8 bg-purple-50 dark:bg-purple-900/20 rounded-xl flex items-center justify-center text-purple-600"
                >
            ...
            <!-- How to Apply -->
            <section
              class="bg-linear-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/10 dark:to-purple-900/10 rounded-[2rem] p-8 md:p-10 border border-indigo-100 dark:border-indigo-900/20"
            >
              <h2 class="text-xl font-black text-slate-900 dark:text-white mb-6">How to Apply</h2>
              <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div class="flex flex-col items-center text-center p-4">
                  <div
                    class="w-12 h-12 bg-white dark:bg-slate-900 rounded-2xl shadow-sm flex items-center justify-center text-indigo-600 mb-3"
                  >
          ...
          <div class="space-y-6">
            ...
            >
              <h3
                class="text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest mb-6"
              >
                Job Summary
              </h3>
              <div class="space-y-5">
                ...
                <SummaryRow
                  ...
                  label="Workplace"
                  :value="job.workplace_type?.replace('_', ' ')"
                />
                <SummaryRow
                ...
                <SummaryRow
                  ...
                  label="Education"
                  :value="job.education_level?.replace('_', ' ') || 'Any'"
                />
                <SummaryRow
                  icon="pi pi-users"
            ...
            >
              ...
              <div class="flex items-center gap-4 mb-5">
                <div
                  class="w-14 h-14 bg-slate-50 dark:bg-slate-800 rounded-2xl flex items-center justify-center overflow-hidden border border-slate-100 dark:border-slate-700"
                >
                  <img
                    :src="job.employer.logo_url || '/default-logo.png'"
              ...
              <div class="space-y-3 mb-6">
                <p
                  v-if="job.employer.company_size"
                ...
                <p
                  v-if="job.employer.headquarters"
                  class="text-xs text-slate-500 dark:text-slate-400 flex items-center gap-2"
                >
                  <i class="pi pi-map-marker text-slate-300"></i> {{ job.employer.headquarters }}
                </p>
                <p
                  v-if="job.employer.founded_year"
                  class="text-xs text-slate-500 dark:text-slate-400 flex items-center gap-2"
                >
                  <i class="pi pi-calendar text-slate-300"></i> Founded
            ...
            <!-- Rating -->
            <div
              v-if="job.employer?.average_rating > 0"
              class="bg-white dark:bg-slate-900 rounded-[2rem] p-8 shadow-sm border border-slate-100 dark:border-slate-800"
            >
              <div class="flex items-center justify-between">
                <div>
                  <p class="text-sm font-black text-slate-900 dark:text-white mb-1">
                    Employee Rating
                  </p>
                  <p class="text-xs text-slate-500 dark:text-slate-400">
                    Based on {{ job.employer.total_reviews || 0 }} reviews
                  </p>
                </div>
                <div
                  class="flex items-center gap-2 bg-amber-50 dark:bg-amber-900/10 px-4 py-2 rounded-xl border border-amber-100 dark:border-amber-900/20"
                >
                  <i class="pi pi-star-fill text-amber-500"></i>
                  <span class="text-xl font-black text-amber-700 dark:text-amber-400">{{
                    job.employer.average_rating
                  }}</span>
                </div>
              </div>
            </div>
            ...
            >
              <h3
                class="text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest mb-4"
              >
                Share this Job
              </h3>
              <div class="flex gap-3">
                <button
                  @click="copyLink"
                  class="flex-1 py-3 bg-slate-50 dark:bg-slate-800 rounded-xl text-xs font-black text-slate-600 dark:text-slate-400 uppercase tracking-widest hover:bg-slate-100 transition-all flex items-center justify-center gap-2"
                >
    ...
    >
      <div
        class="bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 md:p-10 max-w-lg w-full shadow-2xl max-h-[90vh] overflow-y-auto"
      >
        <div class="flex items-center gap-4 mb-6">
          <div
            class="w-12 h-12 bg-indigo-50 dark:bg-indigo-900/20 rounded-2xl flex items-center justify-center text-indigo-600"
          >
            <i class="pi pi-send text-lg"></i>
          </div>
          <div>
        ...
        <div v-else class="space-y-6">
          ...
          <div>
            <label
              class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2"
              >Cover Letter <span class="font-normal normal-case">(optional)</span></label
            >
            <textarea
              v-model="coverLetter"
              rows="5"
...
const jobTypeClass = (type) => {
  const map = {
    ...
    freelance:
      'bg-indigo-50 text-indigo-700 border-indigo-100 dark:bg-indigo-900/10 dark:text-indigo-400 dark:border-indigo-900/20',
    internship:
...
const workplaceClass = (type) => {
  const map = {
    remote:
      'bg-sky-50 text-sky-700 border-sky-100 dark:bg-sky-900/10 dark:text-sky-400 dark:border-sky-900/20',
    on_site:
      'bg-rose-50 text-rose-700 border-rose-100 dark:bg-rose-900/10 dark:text-rose-400 dark:border-rose-900/20',
    hybrid:
      'bg-violet-50 text-violet-700 border-violet-100 dark:bg-violet-900/10 dark:text-violet-400 dark:border-violet-900/20',
  }
  return (
    map[type] ||
    'bg-slate-50 text-slate-600 border-slate-100 dark:bg-slate-800 dark:text-slate-400 dark:border-slate-700'
...
const experienceClass = (level) => {
  const map = {
    junior:
      'bg-teal-50 text-teal-700 border-teal-100 dark:bg-teal-900/10 dark:text-teal-400 dark:border-teal-900/20',
    ...
    executive:
      'bg-yellow-50 text-yellow-700 border-yellow-100 dark:bg-yellow-900/10 dark:text-yellow-400 dark:border-yellow-900/20',
  }
  return (
    map[level] ||
    'bg-slate-50 text-slate-600 border-slate-100 dark:bg-slate-800 dark:text-slate-400 dark:border-slate-700'
