<template>
  ...
  >
    ...
    <div class="max-w-4xl w-full text-center relative z-10 animate-[fadeIn_1s_ease-out]">
      <div
        class="inline-flex items-center gap-3 px-6 py-3 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl mb-12 shadow-2xl shadow-indigo-500/10 hover:-translate-y-1 transition-transform cursor-default mx-auto"
      >
      ...
      <h1
        class="text-7xl md:text-9xl font-black text-slate-900 dark:text-white tracking-tighter italic leading-none mb-8 select-none"
      >
        Crafting <br />
